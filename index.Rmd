...
<div class="header">RStudio Addins</div>
...
<!--
NOTE: I scrapped the "Discovering Addins" section. Rather than that let's just link to a few cool addins right here once they materialize.
-->
...
Try clicking the `insert_in` addin -- you'll see the text ` %in% ` inserted at the cursor position. 

<!-- TODO: Demo an interactive addin? -->
...
### Using the RStudio API

TODO: describe general capabiliites of the API
...
(TODO: we should show an example of exactly what the DCF file will look like here)
...
Perhaps show a couple of other examples.
