...
<div id="release-note">
**IMPORTANT NOTE:** Support for addins is available only within the [Preview Release](https://www.rstudio.com/products/rstudio/download/preview/) of RStudio (v0.99.857 or later). If you want to try out addins please be sure to download the preview release.
</div>
...
The [rstudioapi](https://cran.rstudio.com/web/packages/rstudioapi/index.html) package allows you to interact with RStudio directly from the R code you write. You should install a recent (>= v0.4) version of the **rstudioapi** package to ensure you have access to all of the functions described below:
...
Creating addins with Shiny Gadgets requires recent versions of the **shiny** (v0.13), **miniUI** (v0.1.1), and **rstudioapi** (v0.4) packages from CRAN. You should therefore add these packages (along with their required versions) to your package DESCRIPTION file as follows:
