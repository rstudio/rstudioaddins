...
<a class="thumbnail" href="demo/demo-subset.gif" data-lightbox="examples" data-title="Interactively subset a dataset">
<img class="example-image" src="demo/demo-subset.png"/>
</a>
</div>

<div class="col-xs-6">
#### Interactively reformat R code
<a class="thumbnail" href="demo/demo-reformat.gif" data-lightbox="examples" data-title="Interactively reformat R code">
<img class="example-image" src="demo/demo-reformat.png"/>
</a>
</div>
...
1. Text macros, which insert text into the console or source pane and in some cases transform text within the source pane. The `insert_in` addin defined above is an example of a text macro.
